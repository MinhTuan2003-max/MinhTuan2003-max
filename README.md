...
- 🔧 Built multiple full-stack and backend-focused web applications using **Java**, **Spring Boot**, **JSP/Servlet**, and **MongoDB**
- 🔐 Successfully integrated **OAuth2**, **Keycloak (OIDC + PKCE)** to secure applications and manage authentication flows
- 🔍 Implemented advanced features such as search, pagination, and role-based access in various projects
...
![Servlet](https://img.shields.io/badge/Servlet-2A4D69?style=flat)
...
- 🔗 [**LinkedIn – tuanhm29**](https://www.linkedin.com/in/tuanhm29)
---
